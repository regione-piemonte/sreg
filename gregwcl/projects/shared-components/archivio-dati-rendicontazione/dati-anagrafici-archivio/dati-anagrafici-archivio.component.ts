...
import { ChiudiEnteComponent } from '@greg-operatore/components/chiudi-ente/chiudi-ente.component';
import { StatoEnteArchivioComponent } from './stato-ente-archivio/stato-ente-archivio.component';

@Component({
  selector: 'app-dati-anagrafici-archivio',
  templateUrl: './dati-anagrafici-archivio.component.html',
  styleUrls: ['./dati-anagrafici-archivio.component.css'],
  animations: [
...
export class DatiAnagraficiArchivioComponent implements OnInit {
  ...
  @ViewChild(StatoEnteArchivioComponent, { static: false }) cronologiaStatoMod: StatoEnteArchivioComponent;
...
modifica: boolean = false;
  ...
  this.modificaResp=false;
    ...
    if(this.dataFineValidita==null){
      forkJoin({
		...
		comuni, comAssociati, 
          comunisede, 
		tipoEnte, asl, msgTab, warn, lastStato,comEliminati,comuniIniziali,comunimod }) => {
  ...
  initFormDenominazione(schedaEnte: AnagraficaEnteGreg) {
    this.enteForm = this.fb.group({
      ...
      codiceFiscale: [schedaEnte.codiceFiscale, [Validators.maxLength(11), Validators.required]],
      denominazione: [schedaEnte.denominazione, [Validators.maxLength(300), Validators.required]],
      ...
      codiceIstat: [schedaEnte.codiceIstat, [Validators.maxLength(9), Validators.required]],
  ...
  initResponabileEnteForm(resEnte: ResponsabileEnteGreg) {
    this.responsabileEnteForm = this.fb.group({
      ...
      nome: [resEnte.nome, [Validators.pattern(PATTERN.CHARS), Validators.maxLength(40), Validators.required]],
      cognome: [resEnte.cognome, [Validators.pattern(PATTERN.CHARS), Validators.maxLength(40), Validators.required]],
      ...
      codiceFiscale: [resEnte.codiceFiscale, [Validators.maxLength(16), Validators.required]],

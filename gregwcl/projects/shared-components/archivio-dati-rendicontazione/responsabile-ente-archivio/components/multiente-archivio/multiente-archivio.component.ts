...
@Component({
  selector: 'app-multiente-archivio',
  templateUrl: './multiente-archivio.component.html',
  styleUrls: ['./multiente-archivio.component.css']
})
export class MultienteArchivioComponent implements OnInit, AfterViewInit {

...
@Component({
  selector: 'app-modelloA1-archivio',
  templateUrl: './modelloA1-archivio.component.html',
  styleUrls: ['./modelloA1-archivio.component.css'],
})
export class ModelloA1ArchivioComponent implements OnInit {

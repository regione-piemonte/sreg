...
@Component({
    selector: 'app-modelloA-archivio',
    templateUrl: './modelloA-archivio.component.html',
    styleUrls: ['./modelloA-archivio.component.css'],
    animations: [
...
export class ModelloAArchivioComponent implements OnInit {

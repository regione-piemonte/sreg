...
@Component({
    selector: 'app-modelloB-archivio',
    templateUrl: './modelloB-archivio.component.html',
    styleUrls: ['./modelloB-archivio.component.css']
})
export class ModelloBArchivioComponent implements OnInit {
                    ...
                    if(modify){
                        ...
                        for(let i=0; i<this.rendicontazioneModB.listaMissioni.length; i++){
                            for(let j=0; j<this.rendicontazioneModB.listaMissioni[i].listaProgramma.length; j++){
                                ...
                                if(programma.flagConf && (programma.motivazione == null || programma.motivazione == "")){

...
@Component({
  selector: 'app-modelloE-archivio',
  templateUrl: './modelloE-archivio.component.html',
  styleUrls: ['./modelloE-archivio.component.css'],
  animations: [
...
export class ModelloEArchivioComponent implements OnInit {

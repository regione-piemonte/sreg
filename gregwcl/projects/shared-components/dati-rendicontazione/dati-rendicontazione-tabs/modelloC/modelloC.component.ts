...
@Component({
    selector: 'app-modelloC',
    templateUrl: './modelloC.component.html',
    styleUrls: ['./modelloC.component.css'],
    animations: [
...
export class ModelloCComponent implements OnInit {

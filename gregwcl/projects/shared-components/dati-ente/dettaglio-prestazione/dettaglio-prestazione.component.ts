...
@Component({
  selector: 'app-dettaglio-prestazione',
  templateUrl: './dettaglio-prestazione.component.html',
  styleUrls: ['./dettaglio-prestazione.component.css']
})
export class DettaglioPrestazioneComponent implements OnInit {

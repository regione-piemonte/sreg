...
@Component({
  selector: 'app-cronologia-modelli',
  templateUrl: './cronologia-modelli.component.html',
  styleUrls: ['./cronologia-modelli.component.css'],
 animations: [
...
export class CronologiaModelliComponent implements OnInit {
